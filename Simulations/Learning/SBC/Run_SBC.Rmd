...
# run for all!
```{r}
n_sims <- 50 # Number of SBC iterations to run

generator <- SBC_generator_function(generator_single, N = 60, S = 20)
...
save.image(here::here("Simulations","Learning","SBC","results","50_fits.RData"))
